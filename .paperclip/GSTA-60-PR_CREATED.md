...
Assign:
- Staff Engineer: @staff-engineer (review)
- QA Engineer: @qa-engineer (run acceptance: install plugin package + verify discovery)

Action: Move issue GSTA-60 to in_review after PR creation.
